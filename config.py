...
#--------------------------------------------
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8346161909:AAELptqbZotcdp3NorCBBT2Zq4rPQJDjOb8")
APP_ID = int(os.environ.get("APP_ID", "25489830")) #Your API ID from my.telegram.org
API_HASH = os.environ.get("API_HASH", "b3df97daea65252260b2c2513a94ee5a") #Your API Hash from my.telegram.org
#--------------------------------------------

CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1003598678842")) #Your db channel Id
OWNER = os.environ.get("OWNER", "sewxiy") # Owner username without @
OWNER_ID = int(os.environ.get("OWNER_ID", "7604215581")) # Owner id
#--------------------------------------------
PORT = os.environ.get("PORT", "8001")
#--------------------------------------------
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://chick:chick@cluster0.q2sekas.mongodb.net/?appName=Cluster0")
DB_NAME = os.environ.get("DATABASE_NAME", "Cluooo")
#--------------------------------------------
FSUB_LINK_EXPIRY = int(os.getenv("FSUB_LINK_EXPIRY", "10"))  # 0 means no expiry
BAN_SUPPORT = os.environ.get("BAN_SUPPORT", "https://t.me/MTC_ALL")
...
SHORTLINK_API = os.environ.get("SHORTLINK_API", "e5e45e790e5541b87e25fb023c3d77c144c8b7c4")
...
"""
#--------------------------------------------
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>• ʙʏ @MTC_ALL</b>") #set your Custom Caption here, Keep None for Disable Custom Caption
